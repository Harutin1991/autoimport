...
class Product extends \yii\db\ActiveRecord {
    ...
    public function rules() {
	  return [
		    [['name', 'price', 'rate','product_sku'], 'required'], //,'category_id'
		    [['description', 'route_name', 'addr_1', 'addr_2', 'addr_3','phone1','client_name','mapLink', 'city', 'state', 'email', 'sub_category', 'source', 'json_attr'], 'string'],
		    [['status', 'category_id', 'rate','broker_id'], 'integer'],
		    [['price'], 'number'],
